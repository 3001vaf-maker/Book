...
export function workplaceList() {
  ...
  return listEntries(items.map(w=>listEntry({
    ...
    deleteData:w.key,
    deleteAria:`Удалить место работы ${w.name||''}`
  })));
}
