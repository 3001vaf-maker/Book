...
assert.match(graphSource, /v2HorizontalRail\(cards\.join\(''\)/);
...
assert.doesNotMatch(graphSource, /workplace\?\.city|workplace\?\.address|workplace\?\.from|workplace\?\.to/);
assert.match(graphSource, /topRightMeta/);
