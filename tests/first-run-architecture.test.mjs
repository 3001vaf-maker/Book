...
assert.match(firstRun, /rknGuideTemplate/);
assert.match(firstRun, /ensureRknGuide/);
assert.match(firstRun, /\/usr\/share\/fonts\/dejavu\/DejaVuSans\.ttf/);
assert.doesNotMatch(firstRun, /\/usr\/share\/fonts\/ttf-dejavu\/DejaVuSans\.ttf/);
