...
assert.match(platformArchiveMigration, /ALTER TABLE "LegalDocument" RENAME TO "PlatformDocument"/);
assert.match(platformArchiveMigration, /ALTER TABLE "LegalDocumentVersion" RENAME TO "PlatformDocumentVersion"/);
