...
const dropMigration = read('server/prisma/migrations/20260919125500_remove_booking_account_consents/migration.sql');
...
// The legacy BookingAccount consent snapshot is physically removed in step 3B.
const bookingAccountModel = schema.slice(schema.indexOf('model BookingAccount'), schema.indexOf('model BookingRequest'));
assert.doesNotMatch(bookingAccountModel, /\bconsents\b/);
