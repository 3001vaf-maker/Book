...
assert.match(v2Css, /--v2-e-max-height:calc\(66\.666% - 24px\)/);
assert.match(v2Css, /\.v2-e-deck\{[\s\S]*?top:auto;[\s\S]*?bottom:0;[\s\S]*?height:var\(--v2-e-max-height\)/);
assert.doesNotMatch(v2Css, /--v2-e-top-gap/);
assert.match(v2Css, /\.v2-e-card\{[\s\S]*?bottom:0;[\s\S]*?pointer-events:none/);
assert.match(v2Css, /\.v2-deck__card\{[\s\S]*?pointer-events:none/);
assert.match(v2Css, /\.v2-deck__card strong\{[\s\S]*?height:var\(--v2-card-handle\);[\s\S]*?pointer-events:auto/);
assert.match(v2Css, /\.v2-e-card strong\{[\s\S]*?min-width:var\(--v2-card-handle-min\);[\s\S]*?height:var\(--v2-card-handle\);[\s\S]*?pointer-events:auto/);
