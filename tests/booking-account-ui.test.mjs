...
assert.match(v2Ui, /const depthX = visualDepth \* 6/);
assert.match(v2Ui, /const depthY = visualDepth \* 12/);
...
assert.match(v2Css, /--v2-deck-width:min\(33vw,128px\)/);
assert.match(v2Css, /--v2-deck-top:34px/);
assert.match(v2Css, /--v2-gap:20px/);
assert.match(v2Css, /--v2-z-open-x:calc\(var\(--v2-deck-width\) \+ var\(--v2-gap\)\)/);
