...
assert.match(bookingController, /@UseGuards\(BookingAccountGuard, BookingRequiredConsentGuard\)\s+@Get\(':tenantId\/account\/chat'\)/);
assert.match(bookingController, /@UseGuards\(BookingAccountGuard, BookingRequiredConsentGuard\)\s+@Post\(':tenantId\/account\/chat\/messages'\)/);
