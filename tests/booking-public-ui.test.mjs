...
const publicAccountThemeCss = fs.readFileSync('ui/shell/public-account-theme.css', 'utf8');
...
assert.doesNotMatch(publicMobileCss, /--app-max-width:/);
assert.match(publicMobileCss, /\.app-shell\.app-shell--booking\s*\{[\s\S]*?width:min\(100%,var\(--app-max-width\)\);[\s\S]*?max-width:var\(--app-max-width\);/);
assert.match(publicMobileCss, /\.app-shell\.app-shell--booking \.app-view-shell[\s\S]*?max-width:100%/);
assert.doesNotMatch(publicMobileCss, /max-width:none/);
assert.match(publicAccountThemeCss, /--text:var\(--booking-dark\)/);
assert.match(publicAccountThemeCss, /--button-secondary:var\(--booking-light\)/);
assert.match(publicAccountThemeCss, /\.app-view-shell--booking-flow/);
assert.match(publicAccountThemeCss, /\.app-view-shell--profile \.app-view-shell__screen\s*\{[\s\S]*?align-content:center;[\s\S]*?place-items:center;/);
assert.match(publicAccountThemeCss, /\.booking-client--account\.booking-shape--round/);
assert.match(publicAccountThemeCss, /\.booking-client--account\.booking-shape--straight/);
assert.match(publicAccountThemeCss, /\.booking-client--account\.booking-shape--cut/);
