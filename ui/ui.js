...
export function mountModal(root,html){root.insertAdjacentHTML('beforeend',html);const m=root.querySelector('[data-modal]:last-of-type');m?.addEventListener('click',e=>{if(e.target.matches('[data-modal],[data-modal-close]'))m.remove()});return m}
