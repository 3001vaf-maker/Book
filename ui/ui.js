...
import { calendar, initCalendar } from './calendar/index.js?v=graph-header-meta-20260903';
...
export function timeInput({ label, name, value = '' } = {}) { return timePicker({ label, name, value }); }
