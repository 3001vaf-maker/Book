...
import { workplaceSelector, initWorkplaceSelectors, collectWorkplaceSelections, workplaceAddButton, workplaceHeaderContent, openWorkplaceControl, workplaceCountText, getWorkplaceContext, setWorkplaceContext } from './workplaces/index.js?v=header-control-20260908';
import { pageHeader, headerControl } from './header/index.js?v=header-control-20260908';
