...
export function timePicker({name,label,value='09:00',minuteStep=15,min='00:00',max='23:59'}={}){
...
function open(host){
  ...
  const syncColumn=(viewport,{recenter=true}={})=>{
    ...
    if(!twin)return;
    const delta=twin.offsetTop-nearest.offsetTop;
