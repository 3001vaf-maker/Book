...
| UI Reference V2 shell | `ui/v2/` | `v2Header`, `v2FDeck`, `v2Shell`, `v2Section`, `v2HorizontalRail`, `v2RailCard`, `v2ServiceStickers`, `v2Sticker`, `v2LegalCards`, `v2Layer`, `mountV2Layer`, `initV2Swipe` |
