...
| `collectWorkplaceSelections()` | Собирает выбранные рабочие места | `ui/workplaces/` | Инфраструктура данных UI | Формы с рабочими местами | Данные рабочего места | ОБЩАЯ ДЛЯ ФУНКЦИИ |
