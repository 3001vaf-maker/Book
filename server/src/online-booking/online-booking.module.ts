...
@Module({
  ...
  providers: [OnlineBookingService, TelegramBookingAuthService, TelegramWebAppAuthService, BookingAccountGuard, ClientCardLinkService, MarketingConsentService, PrismaService],
})
