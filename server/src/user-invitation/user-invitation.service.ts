...
const STARTER_PLAN_KEY = 'starter-base';
...
export class UserInvitationService {
  ...
  async createInvitation(adminId: string, input: { email?: unknown; name?: unknown }) {
    ...
    const tenantName = name || email.split('@')[0] || 'Рабочее пространство';
