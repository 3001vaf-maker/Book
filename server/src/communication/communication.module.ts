...
@Module({
  ...
  providers: [ClientProfileThreadService, ClientContactRouteService, InAppProfilePushService, CommunicationService, CommunicationHistoryService, CommunicationChannelResolverService, CommunicationDispatchService, CommunicationBroadcastService, TelegramBotService, PrismaService],
