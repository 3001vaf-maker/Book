...
('frs-v1-online-booking','first-run-default-v1','online-booking',40,'OPTIONAL_INFO','Онлайн-запись','Онлайн-запись','Здесь настраивается онлайн-запись: приветствие, внешний вид и шаг доступного времени. В реальной работе ссылку можно будет передавать людям для самостоятельного выбора услуги и времени. Во время ознакомления не используйте реальные персональные данные и не распространяйте ссылку как рабочую.','Понятно','Пропустить','settings','[data-settings-open="online-booking"]','online-booking.viewed','{"phase":"settings","inspect":["Приветствие","Внешний вид","Время записи"]}',true),
...
('frs-v1-finance-sections','first-run-default-v1','finance-sections',170,'OPTIONAL_INFO','Финансовые разделы','Финансовые разделы','Познакомьтесь с кассой и кошельками, движением денежных средств, доходами и расходами, статьями, прочими операциями и отчётами. Создавать новый кошелёк необязательно.','Понятно','Пропустить','finance','', 'finance.sections-viewed','{"phase":"workspace"}',true),
