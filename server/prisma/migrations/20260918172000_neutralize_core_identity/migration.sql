...
ALTER TYPE "MembershipRole" RENAME VALUE 'MASTER' TO 'USER';
ALTER TYPE "MasterInvitationStatus" RENAME TO "UserInvitationStatus";

ALTER TABLE "TenantAccess"
  RENAME COLUMN "isOwnerBook" TO "isPlatformOwnerWorkspace";

ALTER TABLE "MasterInvitation" RENAME TO "UserInvitation";

ALTER TABLE "UserInvitation"
  RENAME CONSTRAINT "MasterInvitation_pkey" TO "UserInvitation_pkey";
ALTER TABLE "UserInvitation"
  RENAME CONSTRAINT "MasterInvitation_tenantId_fkey" TO "UserInvitation_tenantId_fkey";
ALTER TABLE "UserInvitation"
  RENAME CONSTRAINT "MasterInvitation_createdByAdminId_fkey" TO "UserInvitation_createdByAdminId_fkey";
