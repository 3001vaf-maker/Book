...
assert(service.includes('acceptAccountConsents'), 'online account consent facts must be written to canonical Documents events');
assert(service.includes('acceptContactPointConsent'), 'online messaging consent must be written for exact Contact Points');
