...
assert(migration.includes('hydrateWalletsFromServer') && migration.includes('hydrateTagsFromServer') && migration.includes('hydrateProductsFromServer'), 'Auxiliary startup must hydrate Wallets, Tags and Products from the auxiliary owner.');
