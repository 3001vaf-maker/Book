...
expect(ui.includes("kind === 'logo'") && css.includes('.v2-header__control--logo') && css.includes('.v2-header__slot--c .v2-header__control--text'), 'Shared Header must own the canonical outlined A logo and active C button manifestations.');
