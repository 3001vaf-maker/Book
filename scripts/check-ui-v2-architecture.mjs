...
expect(onlineBookingSettings.includes('workspaceHeaderContext({') && onlineBookingSettings.includes('data-workspace-back-source') === false && onlineBookingSettings.includes('data-v2-primary-action'), 'Online booking settings must feed Header/Back/Save through Shared workspace sources instead of drawing a second shell.');
