...
const allStages = [
  ...
  },
  {
    ...
    render(module, root) {
      ...
      queueMicrotask(() => infoModal('Люди', 'Соберите свою текущую базу людей. Одного человека можно создать кнопкой «+», список — загрузить через Excel. Первая задача — увидеть реальное количество людей, с которыми вы работаете.', 'medium'));
    },
