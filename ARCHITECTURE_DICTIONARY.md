...
- `Account` — входящий аккаунт: конкретная учётная точка входа человека в Book;
- `Person` — одна рабочая бизнес-единица внутри People;
- `UEI` — канонический код идентичности, связывающий несколько исходных записей/Account в одного Person;
- один Person может иметь один или несколько Account;
- один Account относится к одной текущей Person-идентичности;
- одинаковый нормализованный контакт считается уже известным контактом и не должен создавать новую независимую бизнес-единицу;
- другой оригинальный контакт может сначала существовать отдельно, пока его не свяжут с существующей Person через UEI;
- связывание и разъединение через UEI не должно терять Record, Finance, Communication, Documents/Consents или другую историю.
