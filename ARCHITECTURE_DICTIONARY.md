...
`BookingAccount` — технический аккаунт входа клиента и источник конкретного входящего сообщения. Он **не владеет диалогом**. Один профиль может содержать несколько связанных аккаунтов; если у зависимого человека нет отдельного аккаунта, отдельной точки доставки для него не возникает.
...
Telegram и Email — внешние Contact Point. Они могут отображаться в том же профильном диалоге, но отправка наружу выбирает конкретный Contact Point и отдельно проверяет его согласие. Их правила нельзя переносить на IN_APP/PUSH.
